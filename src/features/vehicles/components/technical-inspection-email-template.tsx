...
// export const TechnicalInspectionEmailTemplate: React.FC<Readonly<TechnicalInspectionEmailTemplateProps>> = ({ technicalInspectionDate }) => (
//   <div>
//     <h1>The expiration date of the vehicle technical inspection is approaching {technicalInspectionDate.toDateString()}</h1>
//   </div>
// );
